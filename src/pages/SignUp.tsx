  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--signal-white)] px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-6 flex rounded-xl border border-[var(--signal-silver-light)] p-1 bg-[var(--signal-silver-light)]/20">
          <button
            type="button"
            onClick={() => setRole('fan')}
            className={`flex-1 py-2.5 rounded-lg text-sm font-medium transition-colors ${role === 'fan' ? 'bg-white text-[var(--signal-ink)] shadow' : 'text-[var(--signal-ink-muted)] hover:text-[var(--signal-ink)]'}`}
          >
            Fan
          </button>
          <button
            ...
            className={`flex-1 py-2.5 rounded-lg text-sm font-medium transition-colors ${role === 'artist' ? 'bg-white text-[var(--signal-ink)] shadow' : 'text-[var(--signal-ink-muted)] hover:text-[var(--signal-ink)]'}`}
          >
            Artist
          </button>
        </div>
